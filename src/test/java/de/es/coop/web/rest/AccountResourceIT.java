package de.es.coop.web.rest;

import de.es.coop.CoopApp;
import de.es.coop.config.Constants;
import de.es.coop.domain.Authority;
import de.es.coop.domain.User;
import de.es.coop.repository.AuthorityRepository;
import de.es.coop.repository.UserRepository;
import de.es.coop.security.AuthoritiesConstants;
import de.es.coop.service.UserService;
import de.es.coop.service.dto.PasswordChangeDTO;
import de.es.coop.service.dto.UserDTO;
import de.es.coop.web.rest.vm.KeyAndPasswordVM;
import de.es.coop.web.rest.vm.ManagedUserVM;
...
import static de.es.coop.web.rest.AccountResourceIT.TEST_USER_LOGIN;
